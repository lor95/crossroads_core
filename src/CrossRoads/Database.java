	...
	public static void createConnection() {   
		try {
			...
			if (((e.getErrorCode()==40000) && ("XJ040".equals(e.getSQLState())))) {
				...
				System.exit(0);  // se avviamo per errore una seconda volta l'applicazione, questa fallisce a connettersi perchè già la prima JVM vi è connessa; catch dell'errore e spegnimento conseguente
			} else {
